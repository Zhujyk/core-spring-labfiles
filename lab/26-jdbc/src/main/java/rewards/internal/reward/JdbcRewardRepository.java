...
public class JdbcRewardRepository implements RewardRepository {
	...
	public JdbcRewardRepository(JdbcTemplate jdbc) {
	...
	public RewardConfirmation confirmReward(AccountContribution contribution, Dining dining) {
        ...
        jdbc.update(sql,confirmationNumber,contribution.getAmount().asBigDecimal(),new Date(SimpleDate.today().inMilliseconds()),
