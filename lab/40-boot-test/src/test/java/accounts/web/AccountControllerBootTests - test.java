...
public class AccountControllerBootTests {
	...
	public void accountDetails() throws Exception {
		...
		given(accountManager.getAccount(0L))   //we will be returned with those data
				.willReturn(new Account("1234567890", "John Doe"));

		mockMvc.perform(get("/accounts/0"))  //getRequest, performs a request
	...
	public void accountDetailsFail() throws Exception {
        ...
        mockMvc.perform(get("/accounts/9999"))  //getRequest, performs a request
	...
	public void createAccount() throws Exception {
        ...
        mockMvc.perform(post("/accounts")  //getRequest, performs a request
